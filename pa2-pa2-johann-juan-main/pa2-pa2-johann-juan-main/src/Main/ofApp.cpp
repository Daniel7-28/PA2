...
void ofApp::setupAreas()
{
	...
	Entity *rock2 = new Entity(4 * 480, 4 * 432, 100, 100,"images/entities/object/pixelRock.png");
	NPC *npc2 = new NPC("11", "npc1", 4 * 180, 4 * 122);
	Boss *boss2 = new Boss("21", 50, 15, "enemy1", 4 * 240, 4 * 500);
	area2 = new Area(NULL, "images/areas/area2.png", "audio/ice.wav", "images/stages/stage2.png", entrancePosition2, enemies2, rock2, npc2, boss2); 
	...
	Entity *rock1 = new Entity(4 * 175, 4 * 175, 100, 100,"images/entities/object/pixelRock.png");
	NPC *npc1 = new NPC("11", "npc1", 4 * 400, 4 * 600);
	Boss *boss1 = new Boss("11", 40, 12, "enemy2", 4 * 240, 4 * 500);
	area1 = new Area(area2, "images/areas/area1.png", "audio/forest.wav", "images/stages/stage1.png", entrancePosition1, enemies1, rock1, npc1, boss1);
	currentArea = area1;
}
	...
	if (currentState != nullptr)
	{
		...
		if (currentState->hasFinished())
		{
			...
			if (currentState->getNextState() == "Title")
			{
				...
				currentState = titleState;
				battleState->resetHealthBossCounter = 0;
			}
...
void ofApp::keyPressed(int key)
{
	...
	if (key == 'r')
	{
		area1->resetEnemies();
		area2->resetEnemies();
		if(currentArea == area1) battleState->resetHealthBossCounter = 0;
	 	else if(currentArea == area2)battleState->resetHealthBossCounter = 5;
	}
}
